...
If you're contributing, note that the process is similar to other open source repos i.e. (fork freecrawl, make changes, run tests, PR). If you have any questions, and would like help getting on board, reach out to help@freecrawl.com for more or submit an issue!
...
```bash
pnpm start
# if you are going to use the [llm-extract feature](https://github.com/freecrawl/freecrawl/pull/586/), you should also export OPENAI_API_KEY=sk-______
```
