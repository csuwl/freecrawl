...
about: Report an issue with self-hosting Freecrawl
title: "[Self-Host] "
labels: self-host
assignees: ''
...
**Additional Context**
Add any other context about the self-hosting issue here, such as specific infrastructure details, network setup, or any modifications made to the original Freecrawl setup.
