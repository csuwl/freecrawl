---
title: "Open Researcher, our AI Agent That Uses Freecrawl Tools During Research"
description: "We built a research agent using Anthropic's interleaved thinking and Freecrawl. No orchestration needed."
pubDate: "Jul 01, 2025"
heroImage: "../../assets/blog/or_freecrawl.webp"
category: "updates"
---
...
```
Thinking Block #1: They're asking about the 3rd blog post on freecrawl.dev.
I need to find the blog listing first to count posts chronologically.

Thinking Block #2: I should search for 'site:freecrawl.dev/blog' to get
...
- Freecrawl for web data extraction
