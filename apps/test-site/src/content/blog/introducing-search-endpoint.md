...
```python
from freecrawl import FreecrawlApp, ScrapeOptions

app = FreecrawlApp(api_key="fc-YOUR_API_KEY")
...
- Read the [/search documentation](https://docs.freecrawl.dev/features/search)
- Experiment in the [Playground](https://freecrawl.link/search-pg)
- See /search [examples and templates](https://www.freecrawl.dev/templates)
...
P.S. We’re no longer actively supporting our alpha endpoints /llmstxt and /deep-research starting June 30, 2025. Both will remain active but we just will not be pushing further updates. For an /llmstxt alternative, see this [Freecrawl example](https://github.com/mendableai/create-llmstxt-py). For deep research, check out our new Search API or our open source [Firesearch](https://github.com/mendableai/firesearch) project.
