...
import fs from "fs";
import { DocumentConverter, DocumentType } from "@mendable/freecrawl-rs";

describe("Document Converter tests", () => {
  const samplesDir = path.join(process.cwd(), "samples");

  const expectedHtmlBase = (documentText: string) =>
    `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Document</title></head><body><main><p><strong>Hello!</strong></p><p>${documentText} file to test the Freecrawl Document Converter.</p><p><em>Italic</em></p><p><strong>Bold</strong></p><p>Underlined</p><p><del>Strikethrough</del></p><table><tbody><tr><td>Header 1</td><td>Header 2</td></tr><tr><td>Value 1</td><td>Value 2</td></tr></tbody></table></main></body></html>`;
