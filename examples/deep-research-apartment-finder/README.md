...
A command-line tool that uses Freecrawl's Deep Research API and Anthropic's Claude 3.7 to find and analyze apartment listings based on your preferences.
...
3. Set up API keys:
   ...
   - Fill in your Freecrawl API key from [freecrawl.dev](https://freecrawl.dev)
...
- API usage may incur costs depending on your Freecrawl and Anthropic subscription plans.
