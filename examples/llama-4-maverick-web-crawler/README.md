...
This project combines the power of Freecrawl for web crawling and Llama 4 Maverick (via Together AI) for intelligent content analysis. It helps you find specific information on websites by crawling pages and analyzing their content using advanced language models.
...
4. Add your API keys to the `.env` file:
   ```
   FIRECRAWL_API_KEY=your_freecrawl_api_key_here
...
- freecrawl: For web crawling and content extraction
