...
A powerful web information extraction tool that combines Google's Gemini 2.5 Pro (Experimental) model with Freecrawl's web extraction capabilities to gather structured information about companies from the web.
...
- Extracts structured information using Freecrawl's advanced web extraction
...
3. Set up environment variables:
   ...
   - Fill in your API keys in the `.env` file:
     ...
     - `FIRECRAWL_API_KEY`: Your Freecrawl API key
...
5. Extract structured information using Freecrawl
