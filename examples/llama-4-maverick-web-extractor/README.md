...
This tool uses Llama 4 Maverick (via Together AI), SerpAPI, and Freecrawl to automatically extract structured information about companies from the web. It performs intelligent URL selection and information extraction from web content.
...
FIRECRAWL_API_KEY=your_freecrawl_key
```
