...
A Python tool that uses GPT-4.1, Freecrawl, and SerpAPI to research companies and extract structured information.

## Features

- Search for company information using Google (via SerpAPI)
- Analyze search results with GPT-4.1 to identify relevant URLs
- Extract structured data from websites using Freecrawl
...
- Extract structured data using Freecrawl
